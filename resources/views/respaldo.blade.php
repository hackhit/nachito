...
<form class="formRespaldo" method="POST" action="{{route('crearRespaldo')}}">
  ...
  @include('flash::message') 
   <button type="submit" class="btn btn-primary" name="formRegistrar">Crear Respaldo Base de Datos</button>
...
<table class="table">
  ...
  <tr>
    ...
    <td><button  type="submit" class="btn btn-danger">Borrar Respaldo</button></td>
    </form>
