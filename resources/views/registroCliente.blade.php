...
<div class="main-div">
   ...
   <p>Por favor ingrese su Rut y contraseña</p>
    ...
    <form class="formRegistro" method="POST" id="Login" action="{{route('registrarCliente')}}">
   {{ csrf_field() }}

        <div class="form-group">
            <input type="text" class="form-control" id="inputR" name="rut" required placeholder="Rut cliente">
        </div>
        <div class="form-group">
            <input type="text" class="form-control" id="inputNombre" name="nombre" required placeholder="Nombre Cliente">
        </div>
        <div class="form-group">
            <input type="text" class="form-control" id="inputApe" name="apellido" required placeholder="Apellido Cliente">
        </div>
        <div class="form-group">
            <input type="number" class="form-control" id="inputTele" name="telefono" required placeholder="+569"  max="99999999">
        </div>
        <div class="form-group">
         <input type="text" class="form-control" id="inputCorreo" name="email" required placeholder="Email cliente">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="inputClave" name="password2" placeholder="Repita Contraseña"  required maxlength="30">
